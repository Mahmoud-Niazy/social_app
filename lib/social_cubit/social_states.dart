...
class UploadPostImageSuccessfullyState extends SocialStates{}
class UploadPostImageErrorState extends SocialStates{}

class GetAllPostsLoadingState extends SocialStates{}
class GetAllPostsSuccessfullyState extends SocialStates{}
class GetAllPostsErrorState extends SocialStates{}

class AddLikeSuccessfullyState extends SocialStates{}
class AddLikeLoadingState extends SocialStates{}
class AddLikeErrorState extends SocialStates{}

class GetLikesStates extends SocialStates {}
class GetPostState extends SocialStates {}

class GetAllUsersLoadingState extends SocialStates{}
class GetAllUsersSuccessfullyState extends SocialStates{}
class GetAllUsersErrorState extends SocialStates{}

class SendMessageLoadingState extends SocialStates {}
class SendMessageSuccessfullyState extends SocialStates {}
class SendMessageErrorState extends SocialStates {}

class GetAllMessagesLoadingState extends SocialStates{}
class GetAllMessagesSuccessfullyState extends SocialStates{}
